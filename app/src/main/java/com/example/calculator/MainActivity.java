...
public class MainActivity extends AppCompatActivity {
    ...
    private Button button0,button1,button2,button3,button4,button5,button6,button7,button8,button9,buttonClear,buttonBackspace,
            buttonDivide,buttonMultiply,buttonSubtract,buttonAddition,buttonDot,buttonPercent,buttonEqual;
